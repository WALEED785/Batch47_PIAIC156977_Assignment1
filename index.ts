...
console.log("\n\nTASK 11");
const names: string[] = ["KHIZER", "AWAIS", "HAIDER", "LAIBA"];
...
console.log("\n\nTASK 12");
const F_names: string[] = ["KHIZER", "AWAIS", "HAIDER", "LAIBA"];;
const F_message: string = "Hello, {F_names}! How are you today?";
for (let i = 0; i < F_names.length; i++) {
    const personalizedMessage: string = F_message.replace("{F_names}", F_names[i]);
...
console.log("\n\nTASK 13");
const vehicles: string[] = ["Honda motorcycle", "Tesla Model S", "Ford Mustang", "Toyota Camry"];
...
console.log("\n\nTASK 15");
// const guestList: string[] = ["kHIZER", "AWAIS", "HAIDER"];
const cannotAttend: string = guestList[1]; // The guest at index 1 cannot attend
...
console.log("\n\nTASK 18");
const placesToVisit: string[] = ["Saudia Arabia", "TURKEY", "Egypt", "Jordan", "Iran"];
...
let T_name = 'Waleed';
console.log("Is name.toLowerCase() == 'waleed'? I predict true.");
console.log(T_name.toLowerCase() == 'waleed');
...
console.log("\n\nTASK 32");
const current_users: string[] = ['kHIZER', 'AWAIS', 'HAIDER', 'LAIBA', 'ISRA'];
const new_users: string[] = ['ALI', 'WALEED', 'BABER', 'SHEEZA', 'NIDA'];
...
console.log("\n\nTASK 33");
const numbers_2: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9];
...
console.log("\n\nTASK 40");
function make_album(artist: string, title: string, tracks?: number): Record<string, unknown> {
...
function make_great(magicians: string[]): void {
  ...
  const magician_names_2: string[] = ['Harry Houdini', 'David Copperfield', 'Penn Jillette', 'Teller'];
...
function show_magicians_3(magicians: string[]): void {
  ...
  const magician_names_3: string[] = ['Harry Houdini', 'David Copperfield', 'Penn Jillette', 'Teller'];
  const great_magician_names: string[] = make_great_2([...magician_names_2]);
...
console.log("\n\nTASK 45");
function create_car(manufacturer: string, model: string, ...kwargs: Record<string, unknown>[]): Record<string, unknown> {
